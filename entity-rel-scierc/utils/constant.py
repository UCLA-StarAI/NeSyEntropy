...
# POS_TO_ID = {'O': 0}
POS_TO_ID = {'NN': 0, 'IN': 1, 'JJ': 2, 'DT': 3, 'NNS': 4, ',': 5, '.': 6, 'CC': 7, 'VBN': 8, 'VBZ': 9, 'VBP': 10, 'VBG': 11, 'RB': 12, 'VB': 13, 'TO': 14, 'NNP': 15, 'PRP': 16, '-RRB-': 17, 'CD': 18, '-LRB-': 19, 'WDT': 20, 'PRP$': 21, ':': 22, 'MD': 23, 'VBD': 24, 'JJR': 25, 'WRB': 26, 'FW': 27, 'LS': 28, 'RBR': 29, "''": 30, 'JJS': 31, 'POS': 32, 'EX': 33, 'RP': 34, 'PDT': 35, 'RBS': 36, '``': 37, 'WP': 38, 'NNPS': 39, 'WP$': 40, 'SYM': 41, '#': 42}

DEPREL_TO_ID = {'O': 0}

# annotation guidelines: http://nlp.cs.washington.edu/sciIE/annotation_guideline.pdf
# there was also an 'EVALUATE-FOR' relation which isn't mentioned in the pdf
LABEL_TO_ID = {'NA': 0, 'USED-FOR': 1, 'FEATURE-OF': 2, 'HYPONYM-OF': 3, 'PART-OF': 4, 'EVALUATE-FOR': 5, 'COMPARE': 6, 'CONJUNCTION': 7}

NER_TO_ID = {'O': 0, 'Task': 1, 'Method': 2, 'Metric': 3, 'Material': 4, 'OtherScientificTerm': 5, 'Generic': 6 }
