...
def parse_arguments():
    ...
    parser.add_argument('--data_dir', type=str, default='dataset/sciERC')
    ...
    parser.add_argument('--save_epoch', type=int, default=5000, help='Save model checkpoints every k epochs.')
    ...
    parser.add_argument('--entreg_weight', type=float, default=0.0)
