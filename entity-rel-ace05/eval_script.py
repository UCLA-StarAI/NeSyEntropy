...
def evaluate(model_dir, model='best_model.pt', data_dir='dataset/ace05', dataset='test', out='', seed=1234, gpu_id=3, ilp=False, dist=None):
    ...
    print("{:.2f}\t{:.2f}\t{:.2f}\t{:.2f}".format(relation_f1, arg_f1, (relation_f1 + arg_f1)/2, triples_f1))
    ...
    if ilp:
        ...
        print("{:.2f}\t{:.2f}\t{:.2f}\t{:.2f}".format(ilp_relation_f1, ilp_ner_f1, (ilp_relation_f1 + ilp_ner_f1)/2, triples_f1))
